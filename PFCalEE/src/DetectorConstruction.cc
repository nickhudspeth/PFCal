    ...
    version_(ver), model_(mod), addPrePCB_(false)
{
    ...
    case v_CALICE:
    {
        ...
        lThick.push_back(0.4 * 3.504 * mm);
        lEle.push_back("W");
        lThick.push_back(0.525 * mm);
        lEle.push_back("Si");
        lThick.push_back(1.0 * mm);
        lEle.push_back("PCB");
        lThick.push_back(2.5 * mm);
        lEle.push_back("Air");
    ...
    case v_HGCALEE_TB:
    case v_HGCALEE_TB_gap0:
    case v_HGCALEE_TB_allW:
    case v_HGCALEE_TB_samedEdx:
    case v_HGCAL_2016TB:
    {
        ...
        lThickL.push_back(0.5 * mm);
        lEleL.push_back("Cu");
        lThickL.push_back(0.5 * mm);
        lEleL.push_back("CFMix");
        lThickL.push_back(2.*mm);
        lEleL.push_back("W");
        lThickL.push_back(0.5 * mm);
        lEleL.push_back("CFMix");
        lThickL.push_back(0.5 * mm);
        ...
        {
            lThickR.push_back(0.6 * mm);
            lEleR.push_back("WCu");
            lThickR.push_back(6 * mm);
            lEleR.push_back("Cu");
            lThickR.push_back(0.6 * mm);
            lEleR.push_back("WCu");
        }
        ...
        {
            lThickR.push_back(0.5 * mm);
            lEleR.push_back("Cu");
            lThickR.push_back(2.*mm);
            lEleR.push_back("W");
            lThickR.push_back(0.5 * mm);
            lEleR.push_back("Cu");
        }
        lThickR.push_back(0.1 * mm);
        lEleR.push_back("Si");
        lThickR.push_back(0.1 * mm);
        lEleR.push_back("Si");
        lThickR.push_back(0.1 * mm);
    ...
    case v_HGCAL_v618:
    {
        ...
        std::vector<G4double> lThickL;
        std::vector<std::string> lEleL;
        lThickL.push_back(100.*mm);
        lEleL.push_back("NeutMod");
        lThickL.push_back(2.*mm);
        lEleL.push_back("Al");
        lThickL.push_back(26.*mm);
        lEleL.push_back("Foam");
        lThickL.push_back(2.*mm);
        lEleL.push_back("Al");
        lThickL.push_back(0.5 * mm);
        lEleL.push_back("CFMix");
        lThickL.push_back(wThick);
        lEleL.push_back("W");
        lThickL.push_back(0.5 * mm);
        lEleL.push_back("CFMix");
        lThickL.push_back(0.5 * mm);
    ...
    case v_HGCALEE_v5:
    case v_HGCALEE_v5_gap4:
    case v_HGCAL_v5:
    case v_HGCAL_v5_gap4:
    {
        ...
        lThick1.push_back(180.*mm);
        lEle1.push_back("NeutMod");
        lThick1.push_back(2.*mm);
        lEle1.push_back("Al");
        lThick1.push_back(26.*mm);
        lEle1.push_back("Foam");
        lThick1.push_back(2.*mm);
        lEle1.push_back("Al");
        lThick1.push_back(0 * mm);
        lEle1.push_back("Cu");
        lThick1.push_back(0 * mm);
        lEle1.push_back("W");
        lThick1.push_back(0.5 * mm);
        lEle1.push_back("Cu");
        lThick1.push_back(airThick);
        lEle1.push_back("Air");
        lThick1.push_back(pcbThick);
        lEle1.push_back("PCB");
        lThick1.push_back(0.1 * mm);
        lEle1.push_back("Si");
        lThick1.push_back(0.1 * mm);
        lEle1.push_back("Si");
        lThick1.push_back(0.1 * mm);
        ...
        for (unsigned i = 0; i < 14; i++)
        {
            if (dropLayer_[2 * i])
            {
                lThickR.clear();
                lEleR.clear();
                lThickR.push_back(3 * mm);
                lEleR.push_back("Cu");
                lThickR.push_back(1 * mm);
                lEleR.push_back("Pb");
                ...
                lThickR.push_back(absThickW_[i]);
                lEleR.push_back("W");
                lThickR.push_back(0.5 * mm);
                lEleR.push_back("Cu");
                lThickR.push_back(airThick);
                lEleR.push_back("Air");
                lThickR.push_back(absThickPb_[i]);
                lEleR.push_back("Pb");
                lThickR.push_back(3 * mm);
                lEleR.push_back("Cu");
                lThickR.push_back(0.1 * mm);
            ...
            {
                lThickL.push_back(3 * mm);
                lEleL.push_back("Cu");
                lThickL.push_back(1 * mm);
                lEleL.push_back("Pb");
                //reset to 0.5 Cu and no lead for following layers
                if (i > 0)
                {
                ...
                lThickL.push_back(absThickW_[i]);
                lEleL.push_back("W");
                lThickL.push_back(0.5 * mm);
                lEleL.push_back("Cu");
                lThickL.push_back(airThick);
                ...
                if (dropLayer_[2 * i + 1])
                {
                    ...
                    lThickL.push_back(3 * mm);
                    lEleL.push_back("Cu");
                    lThickL.push_back(absThickPb_[i]);
                    lEleL.push_back("Pb");
                    lThickL.push_back(airThick);
                    lEleL.push_back("Air");
                }
    ...
    case v_HGCALEE_Si80:
    case v_HGCALEE_Si120:
    case v_HGCALEE_Si200:
    case v_HGCALEE_Si500:
    case v_HGCALEE_gap1:
    case  v_HGCALEE_CALICE:
    case v_HGCALEE_inverted:
    case v_HGCALEE_concept:
    case v_HGCALEE_W:
    case v_HGCALEE_gap4:
    case v_HGCALEE_prePCB:
    case v_HGCAL:
    {
        ...
        if (version_ == v_HGCALEE_Si80)
        {
            siWidth = 0.08;
        }
        if (version_ == v_HGCALEE_Si120)
        {
            siWidth = 0.120;
        }
        if (version_ == v_HGCALEE_Si500)
        {
            siWidth = 0.500;
        }
        if (version_ == v_HGCALEE_gap1)
        {
            gap = 1;
        }
        if (version_ == v_HGCALEE_gap4)
        {
            gap = 4;
        }
        if (version_ == v_HGCALEE_CALICE)
        {
            pb1 = 1.07;
        }
        if (version_ == v_HGCALEE_inverted)
        {
            pb2 = 1.63;
            pb1 = 3.32;
        }
        if (version_ == v_HGCALEE_W)
        {
            pb1 = 0.70;
            pb2 = 2.10;
            pb3 = 3.50;
        }
        if (version_ == v_HGCALEE_prePCB)
        {
            addPrePCB_ = true;
        }
        ...
        std::vector<G4double> lThick;
        std::vector<std::string> lEle;
        lThick.push_back(pb1);
        lEle.push_back(version_ == v_HGCALEE_W ? "W" : "Pb");
        lThick.push_back(cu);
        lEle.push_back("Cu");
        //add PCB to shield from delta-rays?
        if (addPrePCB_)
        {
            lThick.push_back(pad);
            lEle.push_back("PCB");
        }
        lThick.push_back(siWidth / 3.);
        lEle.push_back("Si");
        lThick.push_back(siWidth / 3.);
        lEle.push_back("Si");
        lThick.push_back(siWidth / 3.);
    ...
    case v_HGCALHE_CALICE:
    {
        std::vector<G4double> lThick;
        std::vector<std::string> lEle;
        lThick.push_back(16.7 * mm);
        lEle.push_back("Steel");
        lThick.push_back(1.25 * mm);
        lEle.push_back("Air");
        lThick.push_back(2 * mm);
        lEle.push_back("Steel");
        lThick.push_back(1.5 * mm);
        lEle.push_back("CFMix");
        lThick.push_back(1 * mm);
        lEle.push_back("PCB");
        lThick.push_back(0.115 * mm);
        lEle.push_back("Polystyrole");
        lThick.push_back(5 * mm);
        lEle.push_back("Scintillator");
        lThick.push_back(0.115 * mm);
        lEle.push_back("Polystyrole");
        lThick.push_back(2 * mm);
        lEle.push_back("Steel");
...
void DetectorConstruction::buildHGCALFHE(const unsigned aVersion)
{
    ...
    if (aVersion == 6 || aVersion == 624 || aVersion == 618)
    {
        ...
        lThick.push_back(0.5 * mm);
        lEle.push_back("Cu");
        lThick.push_back(15.*mm);
        lEle.push_back("SSteel");
        lThick.push_back(brassthick);
        lEle.push_back("Brass");
        lThick.push_back(0.5 * mm);
        lEle.push_back("Cu");
        lThick.push_back(airThick);
        lEle.push_back("Air");
        lThick.push_back(pcbthick);
        lEle.push_back("PCB");
        lThick.push_back(0.1 * mm);
        lEle.push_back("Si");
        lThick.push_back(0.1 * mm);
        lEle.push_back("Si");
        lThick.push_back(0.1 * mm);
    ...
    else
    {
        ...
        if (aVersion == 41)
        {
            lThick.push_back(52.*mm);
            lEle.push_back("Pb");
        }
        else
        {
            lThick.push_back(40.*mm);
            lEle.push_back("Brass");
        }
        lThick.push_back(0.5 * mm);
        lEle.push_back("Cu");
...
void DetectorConstruction::buildHGCALBHE(const unsigned aVersion)
{
    ...
    lThick.push_back(2.*mm);
    lEle.push_back("Al");
    lThick.push_back(26.*mm);
    lEle.push_back("Foam");
    lThick.push_back(2.*mm);
    lEle.push_back("Al");
    lThick.push_back(65.*mm);
    lEle.push_back("Air");
    lThick.push_back(78.*mm);
    lEle.push_back("Brass");
    if (aVersion == 6)
    {
        lThick.push_back(2.6 * mm);
        lEle.push_back("Air");
        lThick.push_back(3.8 * mm);
        lEle.push_back("Scintillator");
        lThick.push_back(2.6 * mm);
        lEle.push_back("Air");
    }
